...
class UnavailableServiceProvider final : public contracts::IServiceProvider {
public:
    explicit UnavailableServiceProvider(
        std::string reason = "systemd support is unavailable");
