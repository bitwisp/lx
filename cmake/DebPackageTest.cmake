...
file(GLOB lx_checksums "${lx_package_dir}/*.deb.sha256")
list(LENGTH lx_checksums lx_checksum_count)
if(NOT lx_checksum_count EQUAL 1)
    message(FATAL_ERROR "Expected one DEB checksum, found ${lx_checksum_count}")
endif()
list(GET lx_checksums 0 lx_checksum_file)
file(SHA256 "${lx_deb}" lx_actual_checksum)
...
if(lx_checksum_position EQUAL -1)
    message(FATAL_ERROR "DEB checksum does not match package")
endif()
